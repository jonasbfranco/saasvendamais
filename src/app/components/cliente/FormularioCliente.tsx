        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="flex flex-col">
                    <label className="mb-1 font-bold text-sm text-zinc-700">Estado</label>
                    <select
                        className="border border-zinc-300 rounded-md px-4 py-2 focus:outline-none"
                        value={props.cliente?.estado ?? ""}
                        onChange={(e) =>
                            props.onChange?.({ ...props.cliente, estado: e.target.value })
                        }
                    >
